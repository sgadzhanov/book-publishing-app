...
export default function ReadersTrustUs() {
  return (
    <div className="p-30 flex flex-col gap-12">
      <h1 className="text-4xl">Readers trust our book picks</h1>
...
function ListItem({ author, text, works }: Review) {
  return (
    <li key={author} className="max-w-2/5 min-h-40 flex flex-col justify-between gap-4 rounded-lg bg-slate-200 p-4">
      <p>{text}</p>
      <div>
